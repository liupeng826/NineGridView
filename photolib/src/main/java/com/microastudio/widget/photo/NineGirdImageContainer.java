...
import com.microastudio.ninegridview.R;
...
public class NineGirdImageContainer extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mImageView = (NineGridImageView) findViewById(R.id.img_ngv_container_content);
        mImgDelete = (ImageView) findViewById(R.id.img_ngv_container_delete);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mIsDeleteMode) {
            mImageWidth = mWidth * 9 / 10;
            mImageHeight = mHeight * 9 / 10;
        } else {
            mImageWidth = mWidth;
